...
- The aperture hole for the feed track is only 1.2 mm in diameter, matching the feed holes in the paper tape for maximum signal modulation. On both aperture PCBs this hole needs to be drilled out to 1.8 mm to accommodate the LED and phototransistor, as indicated in the silk screen print on the PCB. But do not drill all the way through; this must be drilled as a blind hole, preserving the 1.2 mm optical aperture! Note that extreme care must be exercised in drilling this hole. Use a drill press and/or much care to drill to the right depth. The standard tolerance for a 1.6 mm PCB is ±10%, which means ±0.16 mm. The WP406A10SURDK LED protrudes 1.55 mm up from its body; tolerance is ±0.25 mm, so start with a hole depth of 0.5 mm. Maximum you'd ever need to drill is 1.0 mm, leaving at worst 0.44 mm of wall.

![Feed-track blind-hole drilling on aperture PCB](kicad/papertape_panel-readme.jpg)
